...
if (process.env.NODE_ENV === 'production') {
  ...
  console.log('\x1b[36m%s\x1b[0m', '📝  Moving production.robots.txt to build root');
  execSync("cp ./bin/etc/production.robots.txt ./build/robots.txt", {stdio: 'inherit'});

  console.log('\x1b[36m%s\x1b[0m', '🔍  Moving production.sitemap.xml to build root');
  ...
  console.log('\x1b[36m%s\x1b[0m', '📝  Moving staging.robots.txt to build root');
  execSync("cp ./bin/etc/staging.robots.txt ./build/robots.txt", {stdio: 'inherit'});

  console.log('\x1b[36m%s\x1b[0m', '🔍  Moving staging.sitemap.xml to build root');
